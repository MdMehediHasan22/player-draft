    ...
    return (
        ...
        >
            <div className="p-8 rounded-lg">
                ...
                <p className="mt-4 text-md text-gray-200">Beyond Boundaries Beyond Limits</p>
                <button 
                    onClick={handleCoin} 
                    className="mt-6 px-6 py-3 border-2 border-lime-500 bg-lime-300 hover:bg-lime-400 transition text-black font-semibold rounded-lg"
                >
                    Claim Free Credit
                </button>
            </div>
